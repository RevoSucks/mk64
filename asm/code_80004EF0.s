...
/* 005B2C 80004F2C 3C190014 */  lui   $t9, %hi(D_00145470) # $t9, 0x14
...
/* 005B38 80004F38 27395470 */  addiu $t9, %lo(D_00145470) # addiu $t9, $t9, 0x5470
...
/* 005C40 80005040 3C02800E */  lui   $v0, %hi(D_800DC5A0) # $v0, 0x800e
/* 005C44 80005044 8442C5A0 */  lh    $v0, %lo(D_800DC5A0)($v0)
...
/* 005DC4 800051C4 3C028016 */  lui   $v0, %hi(D_8016001E) # $v0, 0x8016
...
/* 005E18 80005218 2442001E */  addiu $v0, %lo(D_8016001E) # addiu $v0, $v0, 0x1e
glabel .L8000521C
...
/* 005F10 80005310 3C0E800E */  lui   $t6, %hi(D_800DC53C) # $t6, 0x800e
/* 005F14 80005314 8DCEC53C */  lw    $t6, %lo(D_800DC53C)($t6)
...
/* 005F38 80005338 3C02800E */  lui   $v0, %hi(D_800DC5A0) # $v0, 0x800e
/* 005F3C 8000533C 8442C5A0 */  lh    $v0, %lo(D_800DC5A0)($v0)
...
/* 005F50 80005350 3C19800E */   lui   $t9, %hi(D_800DC53C) # $t9, 0x800e
...
/* 005F68 80005368 8F39C53C */  lw    $t9, %lo(D_800DC53C)($t9)
...
/* 006718 80005B18 3C04800E */  lui   $a0, %hi(D_800DC53C) # $a0, 0x800e
/* 00671C 80005B1C 8C84C53C */  lw    $a0, %lo(D_800DC53C)($a0)
...
/* 006A6C 80005E6C 3C02800E */  lui   $v0, %hi(D_800DC53C) # $v0, 0x800e
/* 006A70 80005E70 8C42C53C */  lw    $v0, %lo(D_800DC53C)($v0)
